...
class GameUI:
    ...
    def create_game_select_dialog(self):
        ...
        # 修改Breakout按钮的绑定函数
        ttk.Button(content_frame, text="Breakout", command=self.open_breakout_game).pack(padx=5, pady=10)
        ttk.Button(content_frame, text="Snake", command=self.open_snake_game).pack(padx=5, pady=10)
        ttk.Button(content_frame, text="关闭", command=self.on_close_game_select).pack(padx=5, pady=10)
